...
/*equals()메서드
 자바에서 인스턴스의 내용비교를 위해 비교연산자(==)을 사용하는것은
 단순히 참조값에 대한 비교를 하는것이므로, 실제 내뇽에 대한 비교가 
 이루어지지 않는다.
 인스턴스간의 내용 비교를 위해서는 equals() 메서드를 각 
 클래스에 맞게 오버라이딩하여 사용해야한다. 
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		/*인스턴스간의 비교를 할때는 단순히 참조변수에 대한 
		 비교를 하면 안되고, 실제 내용에 대한 비교를 해야한다.*/
